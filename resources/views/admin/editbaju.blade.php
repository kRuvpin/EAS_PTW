                    ...
                    <div class="col-12 col-lg-20">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="/admin/baju/proses/" method="post">
                                @foreach($baju as $bj)
                                {{csrf_field('')}}
                                <input type="hidden" name="idbaju" value="{{$bj->idbaju}}">
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        <label for="kodebaju">Kode Baju</label>
                                        <span type="text" name="kodebaju" id="kodebaju" class="form-control">{{$bj->kodebaju}}</span>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label for="harga">Harga</label>
                                        <input type="text" name="harga" id="harga" class="form-control" value="{{$bj->harga}}"></input>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label for="userid">Stok</label>
                                        <input type="text" name="stok" id="kodepembayaran" class="form-control" value="{{$bj->stok}}"></input>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label for="deskripsi">Deskripsi</label>
                                        <input type="text" name="deskripsi" id="deskripsi" class="form-control" value="{{$bj->deskripsi}}"></input>
                                    </div>
