                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        ...
                        <div class="cart-table clearfix">
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="price">
                                            <a href="/admin/laporan/edit/{{$trx->kodepembayaran}}">
                                                <i class="zmdi zmdi-edit"></i>
                                            </a>
                                            <a href="/admin/laporan/delete/{{$trx->kodepembayaran}}">
                            ...
                            @foreach($total as $trx)
                            Total Pendapatan: {{$trx->total}}
                            @endforeach
                        </div>
                    </div>
                </div>
