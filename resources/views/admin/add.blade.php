                ...
                <div class="row">
                    <div class="col-12 col-lg-20">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form class="cart clearfix" action="/admin/baju/add/proses" method="post" enctype="multipart/form-data">
                                {{csrf_field('')}}
                                <div class="row">
                                    ...
                                    <p>Stok</p>
                                    <div class="quantity">
                                        <span class="qty-minus" onclick="var effect = document.getElementById('stok'); var qty = effect.value; if( !isNaN( qty )) effect.value--;return false;"><i class="fa fa-caret-down" aria-hidden="true"></i></span>
                                        <input type="number" class="qty-text" id="stok" step="1" min="1" max="300" name="stok" value="1">
                                        <span class="qty-plus" onclick="var effect = document.getElementById('stok'); var qty = effect.value; if( !isNaN( qty )) effect.value++;return false;"><i class="fa fa-caret-up" aria-hidden="true"></i></span>
                                    </div>
                                    </div>
                                    <div class="col-12 mb-3">
